...
# clear the screen
# base on https://github.com/atarallo/TECMINT_MONITOR

while getopts ivh name; do # getopts 有三个参数，分别执行安装，查看版本，帮助说明
    case $name in
    i) iopt=1 ;;
    v) vopt=1 ;;
    h) hopt=1 ;;
